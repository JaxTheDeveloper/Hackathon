...
p=figure(x_axis_type='datetime',height=50, width=500, sizing_mode = "scale_width", title="Khoang thoi gian tap trung")
p.yaxis.minor_tick_line_color=None
p.yaxis.ticker.desired_num_ticks = 1

hover=HoverTool(tooltips=[("Start","@Start_string"),("End","@End_string"),('Start Position (Face)',"@Pos_Str"),('End Position (Face)' ,"@Pos_End")])
p.add_tools(hover)
